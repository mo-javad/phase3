...
public class CommentForRestaurant {
    ...
    public static void saveRestaurantCommentToFile(){
        try {
            FileWriter fileWriterRestaurantComment = new FileWriter("src\\\\main\\\\java\\files\\restaurantComments.json");
            Gson gson = new Gson();
    ...
    public static ArrayList<CommentForRestaurant> loadRestaurantCommentFromFile(){
        try {
            ...
            fileReaderRestaurantComment = new FileReader("src\\\\main\\\\java\\files\\restaurantComments.json");
